...
function showContent(yehoodie) {
  ...
  //preload image into the hidden container
  $('#hiddenImage').css('background', 'url(../img/png/yehoodie_'+yehoodie.slug+'.png) no-repeat -9999px -9999px;)');
  console.log('here')
  $('#hiddenImage').imagesLoaded( function() {
    console.log('loaded');
    //when ready - hide spinner
